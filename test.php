                        ...
                        <div class="mx-2">
                            <div class="form-group">
                                <div class="input-group date" id="yearpicker">
                                    <input type="text" class="form-control border-0" name="search_y_grad" placeholder="Select Year Graduated" id="filter" style="border-radius:1rem 0 0 1rem ;">
                        ...
                        error_reporting(0);
                            ...
                            if(mysqli_num_rows($data) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td class="year-grad"><?php echo $row['year_graduated']; ?></td>
                                    <td class="p-grad"><?php echo $row['program_graduated']; ?></td>
                                </tr>
                            <?php 
                                }
                            }
